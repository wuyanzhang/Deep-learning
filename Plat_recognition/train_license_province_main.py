...
if __name__ == '__main__' and sys.argv[1] == 'train':
    ...
    for i in range(0,NUM_CLASSES):
        dir = 'E:/tensorflow_model/plat_recognition/dataset/train_images/training-set/chinese-characters/%s/' % i
            ...
            for h in range(0,height):
                for w in range(0,width):
                    ...
                    if img.getpixel((w, h)) > 230:
                        input_images[index-1][w + h * width] = 0
                    else:
                        input_images[index-1][w + h * width] = 1
            input_labels[index][i] = 1
            index += 1
    # 预处理数据,验证集
    val_count = 0
    for i in range(0, NUM_CLASSES):
        dir = 'E:/tensorflow_model/plat_recognition/dataset/train_images/validation-set/chinese-characters/%s/' % i
    ...
    with tf.Session() as sess:
        ...
        for it in range(iterations):
            ...
            if it % 5 == 0:
                ...
                if val_accuracy > 0.999 and it >= 150:
                    break
